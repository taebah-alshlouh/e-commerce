            ...
            <div class="container">
                <div class="wrapper">
                    <div class="breadcrumb">
                        <ul class="flexitem">
                            <li><a href="./index.html">Home</a></li>
                            <li><a href="./page-category.html">Women's</a></li>
                            ...
                            <div class="flexwrap">
                                <div class="row">
                                    <div class="item is_sticky">
                                        <div class="price">
                                            <span class="discount">25%<br>OFF</span>
                                        </div>
                                        <div class="big-image">
                                            <div class="big-image-wrapper swiper-wrapper">
                                                <div class="image-show swiper-slide">
                                                    <a data-fslightbox href="assets/products/p6.png"><img src="assets/products/p6.png" alt=""></a>
                                                </div>
                                                <div class="image-show swiper-slide">
                                                    <a data-fslightbox href="assets/products/p6-1.png"><img src="assets/products/p6-1.png" alt=""></a>
                                                </div>
                                                <div class="image-show swiper-slide">
                                                    <a data-fslightbox href="assets/products/p6-2.png"><img src="assets/products/p6-2.png" alt=""></a>
                                                </div>
                                            </div>
                                        ...
                                        <div thumbSlider="" class="small-image">
                                            <ul class="small-image-wrapper flexitem swiper-wrapper">
                                                 ...
                                                 <li class="thumbnail-show swiper-slide">
                                                    <img src="assets/products/p6-1.png" alt="">
                                                 </li>
                                                 <li class="thumbnail-show swiper-slide">
                                                    <img src="assets/products/p6-2.png" alt="">
                                                 </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="item">
                                        <h1>CONTRAST KNIT DRESS WITH CUTWORK EMBROIDERY</h1>
                                        <div class="content">
                                            <div class="rating">
                                                <div class="stars"></div>
                                                <a href="#" class="mini-text">2,524 reviews</a>
                                            ...
                                            <div class="stock mini-text" data-stock="4000">
                                                <div class="qty">
                                                    <span>Sold: <strong class="qty-sold">3547</strong></span>
                                                    <span>Stock: <strong class="qty-available">788</strong></span>
                                                </div>
                                                <div class="bar">
                                                    <div class="available">
                                            ...
                                            <div class="description collapse">
                                                <ul>
                                                    <li class="has-child expand">
                                                        ...
                                                        <ul class="content">
                                                            <li><span>Brands</span>Zara</li>
                                                            <li><span>Activity</span>Running</li>
                                                            <li><span>Material</span>70% cotton · 30% polyester
                                                                SECONDARY FABRIC
                                                                97% cotton · 3% elastane</li>
                                                    ...
                                                    <li class="has-child">
                                                        ...
                                                        <div class="content">
                                                            <p>To assess compliance, we have developed a programme of audits and continuous improvement plans.</p>
                                                    ...
                                                    <li class="has-child">
                                                        <a href="#" class="icon-small">Reviews<span class="mini-text">5.7k</span></a>
                                                        <div class="content">
                                                            <div class="reviews">
                                                                        ...
                                                                        <ul>
                                                                            <li class="item">
                                                                                <div class="review-form">
                                                                                    <p class="person">Review by Tala</p>
                                                                                    <p class="mini-text">On 3/3/23</p>
                                                                                </div>
                                                                                ...
                                                                                <div class="review-text">
                                                                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Esse error debitis asperiores minima tempora laborum soluta labore earum temporibus quod doloribus quia, modi saepe distinctio, sint nulla mollitia quaerat unde!                                                        </p>
                                                                                </div>
                                                                            </li>
                                                                            <li class="item">
                                                                                <div class="review-form">
                        ...
                        <div class="products main flexwrap">
                            <div class="item">
                                ...
                                <div class="content">
                                    <div class="offer flexitem">
                                        <p class="mini-text">Offer end at</p>
                                        <ul class="flexcenter">
                                            <li>1</li>
                                            <li>15</li>
                                            <li>27</li>
                                    ...
                                    <div class="stock mini-text" data-stock="4000">
                                        <div class="qty">
                                            <span>Sold: <strong class="qty-sold">2100</strong></span>
                                            <span>Stock: <strong class="qty-available">800</strong></span>
                                        </div>
                                        <div class="bar">
                                            <div class="available">
                                            </div>
                                ...
                                <div class="content">
                                    ...
                                    <div class="stock mini-text" data-stock="4000">
                                        <div class="qty">
                                            ...
                                            <span>Stock: <strong class="qty-available">952</strong></span>
                                        </div>
                                        <div class="bar">
                                            <div class="available">
                                            </div>
                            ...
                            <div class="item">
                                ...
                                <div class="content">
                                    ...
                                    <div class="stock mini-text" data-stock="4000">
                                        <div class="qty">
                                            <span>Sold: <strong class="qty-sold">350</strong></span>
                                            <span>Stock: <strong class="qty-available">78</strong></span>
                                        </div>
                                        <div class="bar">
                                            <div class="available">
                                            </div>
                            ...
                            <div class="item">
                                ...
                                <div class="content">
                                    ...
                                    <div class="stock mini-text" data-stock="4000">
                                        <div class="qty">
                                            <span>Sold: <strong class="qty-sold">957</strong></span>
                                            <span>Stock: <strong class="qty-available">2690</strong></span>
                                        </div>
                                        <div class="bar">
                                            <div class="available">
                                            </div>
                            ...
                            <div class="item">
                                ...
                                <div class="content">
                                    ...
                                    <div class="stock mini-text" data-stock="4000">
                                        <div class="qty">
                                            <span>Sold: <strong class="qty-sold">3500</strong></span>
                                            <span>Stock: <strong class="qty-available">500</strong></span>
                                        </div>
                                        <div class="bar">
                                            <div class="available">
                                            </div>
                            ...
                            <div class="item">
                                ...
                                <div class="content">
                                    ...
                                    <div class="stock mini-text" data-stock="4000">
                                        <div class="qty">
                                            <span>Sold: <strong class="qty-sold">3899</strong></span>
                                            <span>Stock: <strong class="qty-available">101</strong></span>
                                        </div>
                                        <div class="bar">
                                            <div class="available">
                                            </div>
